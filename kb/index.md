...
- [[plans/devin-provider|Devin provider and preset authority]] — Reactivated on 2026-09-16: the owner accepted reading remaining quota and reset times from the pinned official CLI's `/usage` panel, with exact version pinning and fail-closed unknowns. Phase 1 delivered that reader and Phase 2 restored the ACP runtime adapter on the current seam as an unwired port; the refusals stay in place until Phase 3.
