...
- [[plans/devin-provider|Devin provider and preset authority]] — Reactivated on 2026-09-16: the owner accepted reading remaining quota and reset times from the pinned official CLI's `/usage` panel, with exact version pinning and fail-closed unknowns. Phase 1 delivers that reader; the retired runtime and its refusals stay in place until later phases.
