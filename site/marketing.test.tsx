...
describe("public server marketing composition", () => {
  ...
  test("keeps activation warnings beside examples and exact setup commands in their owning guide", () => {
    ...
    expect(notice?.textContent).toContain("The v0.8.3 CLI artifact is admitted for installation");
    const future = parseHTML(renderMarketingPage({ ...publicContent, releaseVersion: "0.8.4" })).document;
