...
export const OOMPA_INSTALL_CLI_SHA256 = "1557993cc04d26f0d65dff9b1b0925f9f501e3013df560bfaa2595b779bfd215";

const expectedPackageName = "@hraness/oompa";
const expectedPackageVersion = "0.8.1";
const expectedArchiveUrl = "https://github.com/hraness/oompa/releases/download/v0.8.1/hraness-oompa-0.8.1.tgz";
...
const parseArchiveIdentity = (value: Record<string, unknown>): InstallArchiveIdentity => {
  ...
  if (value.archiveSource === "official") {
    if (
      ...
      || value.archiveReleaseTag !== "v0.8.1"
