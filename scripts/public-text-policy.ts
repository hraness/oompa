...
const textFile = /(?:^|\/)(?:CODEOWNERS|LICENSE|\.bun-version|\.editorconfig|\.env\.example|\.gitattributes|\.gitignore)$|\.(?:c|css|h|html|json|ld|lock|md|mjs|ps1|rs|svg|toml|ts|tsx|txt|xml|yaml|yml|zig)$/u;
